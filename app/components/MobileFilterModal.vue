<template>
  ...
  >
    <!-- Backdrop -->
    <div class="relative top-0 left-0 w-full h-full bg-black/50 backdrop-blur-sm"  @click="closeModal"></div>
    ...
    overflow-y-auto menu-scroll ">
      <button 
        @click="closeModal"
        class="absolute right-6 top-6 z-50 flex bg-brand-main dark:bg-brand-green items-center justify-center size-10 rounded-lg 
        cursor-pointer"
      >
        <svg class="fill-white dark:fill-brand-element-dark" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
